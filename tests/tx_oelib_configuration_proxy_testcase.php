...
require_once(t3lib_extMgm::extPath('oelib')
	.'class.tx_oelib_configuration_proxy.php');

define('OELIB_EXTENSION_KEY', 'oelib');

class tx_oelib_configuration_proxy_testcase extends tx_phpunit_testcase {
	private $fixture;
	...
	protected function setUp() {
		$this->fixture = tx_oelib_configuration_proxy::getInstance(OELIB_EXTENSION_KEY);
	...
	public function testGetInstanceThrowsExeptionIfNoExtensionKeyGiven() {
		try {
			tx_oelib_configuration_proxy::getInstance('');
	...
	public function testSingleton() {
		$this->assertSame(
			$this->fixture,
			tx_oelib_configuration_proxy::getInstance(OELIB_EXTENSION_KEY)
		);
	}

	public function testInstanciateOfAnotherProxyCreatesNewObject() {
		$otherConfiguration = tx_oelib_configuration_proxy::getInstance('other_extension');
