...
class tx_oelib_Visibility_Tree {
	 ...
	 * @param tx_oelib_Visibility_Node $parentNode the parent node for the
	 *                                 current key
	 */
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/oelib/Visibility/class.tx_oelib_Visibility_Tree.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/oelib/Visibility/class.tx_oelib_Visibility_Tree.php']);
}
?>