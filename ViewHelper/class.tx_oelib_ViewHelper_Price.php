...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/oelib/ViewHelper/class.tx_oelib_ViewHelper_Price.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/oelib/ViewHelper/class.tx_oelib_ViewHelper_Price.php']);
}
?>